...
import { useAddOrderMutation } from '../../feature/auth/authApiSlice';
const Orders = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log('successfully order the book')
      navigate(`/order/${newOrder.email}`)
    } catch (error) {
                  ...
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    ...
                    <div className="md:col-span-5">
                      ...
                      <input
                        ...
                        type="number" name="phone" id="phone" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="+2519 4565 7890" />
                    </div>
