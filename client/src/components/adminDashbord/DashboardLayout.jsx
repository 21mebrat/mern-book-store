...
import { HiBookOpen, HiViewGridAdd } from "react-icons/hi";
      ...
      <aside className="hidden sm:flex sm:flex-col">
        ...
        <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
          <nav className="flex flex-col mx-4 my-6 space-y-4">
            <a href="file:///D:/Node_project_packages/ReduxPractice/client/src/assets/Books/" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            ...
            <Link to="/dashboard/add-new" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
          ...
          <div className="flex flex-shrink-0 items-center ml-auto">
            <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
              ...
              <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                <img src={img} alt="user profile photo" className="h-full w-full object-cover" />
              </span>
        ...
        <main className="p-6 sm:p-10 space-y-6 ">
          <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            ...
            <div className="flex flex-col md:flex-row items-start justify-end -mb-3">
              ...
              <Link to="/dashboard/add-new" className="inline-flex px-5 py-3 text-white bg-purple-600 hover:bg-purple-700 focus:bg-purple-700 rounded-md ml-6 mb-3">
